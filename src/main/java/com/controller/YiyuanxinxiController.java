...
public class YiyuanxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YiyuanxinxiEntity yiyuanxinxi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YiyuanxinxiEntity yiyuanxinxi, HttpServletRequest request){
        EntityWrapper<YiyuanxinxiEntity> ew = new EntityWrapper<YiyuanxinxiEntity>();
		PageUtils page = yiyuanxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yiyuanxinxi), params), params));
        return R.ok().put("data", page);
    }
