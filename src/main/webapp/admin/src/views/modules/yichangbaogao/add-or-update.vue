          ...
          <el-form-item v-if="ruleForm.riqi" label="日期" prop="riqi">
              <el-input v-model="ruleForm.riqi" 
                placeholder="日期" readonly></el-input>
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'" label="疫情情况" prop="yiqingqingkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="疫情情况"
                  v-model="ruleForm.yiqingqingkuang">
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yiqingqingkuang" label="疫情情况" prop="yiqingqingkuang">
                    <span>{{ruleForm.yiqingqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='yiqingqingkuang'){
            this.ruleForm.yiqingqingkuang = obj[o];
            continue;
          }
                    if(o=='riqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yichangbaogao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yichangbaogaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
                }
              });
            } else {
