      ...
      <div class="table-content">
        <el-table
            ...
            <el-table-column
                ...
                label="操作">
                <template slot-scope="scope">
                                <el-button v-if="isAuth('yiyuanxinxi','查看')" type="text" icon="el-icon-edit" size="small" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
                                                                <el-button v-if="isAuth('yiyuanxinxi','预约')" type="text" icon="el-icon-edit" size="small" @click="yuyuexinxiCrossAddOrUpdateHandler(scope.row,'cross')">预约</el-button>
                                                                <el-button v-if="isAuth('yiyuanxinxi','修改')" type="text" icon="el-icon-edit" size="small" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
                <el-button v-if="isAuth('yiyuanxinxi','删除')" type="text" icon="el-icon-delete" size="small" @click="deleteHandler(scope.row.id)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
                                                                                                                                                                                                <el-pagination
...
export default {
  ...
  methods: {
      ...
      this.$storage.set('crossTable','yiyuanxinxi');
      this.$nextTick(() => {
